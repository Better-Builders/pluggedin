        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {allCategories.map((cat) => {
            ...
            return (
              ...
              >
                <div className="group relative flex h-full flex-col rounded-2xl border border-border bg-card p-6 transition-all duration-200 hover:border-accent/40 hover:bg-card-hover hover:shadow-lg hover:shadow-accent-glow">
                  {/* Header */}
                    ...
                    <div className="mt-auto pt-5 border-t border-border/50 mt-5">
                      ...
                      <div className="flex items-center gap-2">
                        {topThree.map((agent) => (
                          ...
                          >
                            <div
                              className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br ${gradient} text-white text-[10px] font-bold`}
                            >
                              {agent.avatar}
                            </div>
